...
<head>
    ...
    <title>Anime On Going | Shinakamana</title>
</head>
<body>
    ...
    <div class="container">
      <div class="container">
        <h1 class="my-4 judul text-center">Anime On Going</h1>
                ...
                <div class="row align-items-center d-flex justify-content-center">
                  ...
                  <div class="col-lg-5 col-md-6 col-sm-12 fs-6">
                    ...
                    <div class="row row-cols-4 row-cols-md-1 row-cols-sm-12 d-flex justify-content-center">
                      ...
                      <p style="margin-bottom: 0px;"><i class="bi bi-star-fill"></i> 8.84</p>
                      <p style="margin-bottom: 0px;"><i class="bi bi-collection-fill"></i> 12 Eps</p>
                    </div>
                  </div>
